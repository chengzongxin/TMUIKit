...
- (UIViewController *)responder_viewController {
    return [[self class] responder_viewControllerOfView:self];
}

+ (UIViewController *)responder_viewControllerOfView:(UIView *)view {
...
- (UINavigationController *)__navVc {
    UIViewController *vc = self.responder_viewController;
