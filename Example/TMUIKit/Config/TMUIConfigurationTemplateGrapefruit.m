//
//  TMUIConfigurationTemplateGrapefruit.m
//  TMUIKit_Example
//
...
@implementation TMUIConfigurationTemplateGrapefruit
...
- (void)applyConfigurationTemplate {
    ...
    TMUICMI.navBarBackgroundImage = [TDUIHelper navigationBarBackgroundImageWithThemeColor:UIColor.td_tintColor];
}
...
- (NSString *)themeName {
    return TDThemeIdentifierGrapefruit;
}
