 ...
 */
- (void)SG_imagePositionStyle:(SGImagePositionStyle)imagePositionStyle spacing:(CGFloat)spacing btn:(UIButton *)btn{
    if (imagePositionStyle == SGImagePositionStyleDefault) {
        ...
        //CGFloat imageWW = btn.width;
        //CGFloat titleWW = btn.width;
        //CGFloat imageWWs = btn.width;
        if (self.contentHorizontalAlignment == UIControlContentHorizontalAlignmentLeft) {
