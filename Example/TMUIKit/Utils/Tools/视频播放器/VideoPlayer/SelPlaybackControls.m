...
- (void)setupUI
{
    ...
    [_bottomControlsBar addSubview:self.voiceButton];
...
- (void)makeConstraints
{
    ...
    [_playTimeLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo(_voiceButton.mas_right).offset(5);
    ...
    [_progress mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo(_playTimeLabel.mas_right).offset(8);
...
- (UIButton *)playButton
{
    if (!_playButton){
        ...
        [_playButton setImage:[UIImage imageNamed:@"医美_视频_播放"] forState:UIControlStateNormal];
        [_playButton setImage:[UIImage imageNamed:@"医美_视频_暂停"] forState:UIControlStateSelected];
...
- (UIButton *)fullScreenButton
{
    if (!_fullScreenButton) {
        ...
        [_fullScreenButton setImage:[UIImage imageNamed:@"医美_视频_全屏"] forState:UIControlStateNormal];
        [_fullScreenButton setImage:[UIImage imageNamed:@"医美_视频_缩小"] forState:UIControlStateSelected];
...
- (UILabel *)playTimeLabel
{
    if (!_playTimeLabel) {
        ...
        _playTimeLabel.font = [UIFont pingFangSCMedium:12];
...
- (UILabel *)totalTimeLabel
{
    if (!_totalTimeLabel) {
        ...
        _totalTimeLabel.font = [UIFont pingFangSCMedium:12];
...
- (UIButton *)retryButton
{
    if (!_retryButton) {
        ...
        [_retryButton setImage:[UIImage imageNamed:@"医美_视频_重载"] forState:UIControlStateNormal];
...
- (UIButton *)voiceButton
{
    if(!_voiceButton)
    {
        ...
        [_voiceButton setImage:[UIImage imageNamed:@"医美_视频_声音"] forState:UIControlStateNormal];
        [_voiceButton setImage:[UIImage imageNamed:@"医美_视频_静音"] forState:UIControlStateSelected];
...
- (void)voiceAction:(UIButton *)btn
{
    ...
    if (_delegate && [_delegate respondsToSelector:@selector(voiceButtonAction:)]) {
        [_delegate voiceButtonAction:btn.selected];
    }
}
