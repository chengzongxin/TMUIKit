...
- (void)setup {
    [self setThumbImage:[UIImage imageNamed:@"医美_视频_小圆点"] forState:UIControlStateHighlighted];
    [self setThumbImage:[UIImage imageNamed:@"医美_视频_小圆点"] forState:UIControlStateNormal];
    self.minimumTrackTintColor =  X16Color(@"#00C3CE");
}
