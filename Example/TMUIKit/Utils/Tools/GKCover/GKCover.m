...
+ (instancetype)translucentCoverWithTarget:(id)target action:(SEL)action
{
    ...
    cover.backgroundColor = [_bgColor colorWithAlphaComponent:kAlpha] ? [_bgColor colorWithAlphaComponent:kAlpha] : [[UIColor blackColor] colorWithAlphaComponent:kAlpha];;
