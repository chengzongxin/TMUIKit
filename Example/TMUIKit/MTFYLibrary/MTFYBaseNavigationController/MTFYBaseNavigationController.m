//
//  MTFYBaseNavigationController.m
//  Matafy
//
...
@interface MTFYGestureRecognizerDelegate : NSObject <UIGestureRecognizerDelegate>

@property (nonatomic, weak) MTFYBaseNavigationController *navigationController;

- (instancetype)initWithNavigationController:(MTFYBaseNavigationController *)navigationController;

@end

@implementation MTFYGestureRecognizerDelegate
...
@interface MTFYBaseNavigationController () <UINavigationControllerDelegate>
...
@property (nonatomic, strong) MTFYGestureRecognizerDelegate *gestureRecognizerDelegate;
...
@implementation MTFYBaseNavigationController
...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.gestureRecognizerDelegate = [[MTFYGestureRecognizerDelegate alloc] initWithNavigationController:self];
...
- (void)pushViewController:(UIViewController *)viewController animated:(BOOL)animated
{
    ...
    viewController.navigationItem.leftBarButtonItem = [self itemWithTarget:self action:@selector(didClickBackButton) image:@"ico_back" highImage:@"ico_back"];
