...
- (void)hbd_setNeedsUpdateNavigationBar {
    if (self.navigationController && [self.navigationController isKindOfClass:[MTFYBaseNavigationController class]]) {
        MTFYBaseNavigationController *nav = (MTFYBaseNavigationController *)self.navigationController;
...
- (void)mtfy_setNaviBarBackgroundAlpha:(CGFloat)alpha {
//    [self wr_setNavBarBackgroundAlpha:alpha];
    self.hbd_barAlpha = alpha;
}

- (void)mtfy_setNaviTitleColor:(UIColor *)titleColor {
    NSMutableDictionary *newTitleTextAttributes = nil;

    if (!self.hbd_titleTextAttributes) {
        newTitleTextAttributes = [NSMutableDictionary dictionary];
    } else {
        newTitleTextAttributes = [self.hbd_titleTextAttributes mutableCopy];
    }
    
    newTitleTextAttributes[NSForegroundColorAttributeName] = titleColor;
    self.hbd_titleTextAttributes = newTitleTextAttributes;
}
