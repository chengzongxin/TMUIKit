...
//  TMContentAlert
//
//  Created by nigel.ning on 04/14/2020.
//  Copyright (c) 2020 nigel.ning. All rights reserved.
//
...
- (void)okBtnClick {
    if (self.useAnimate) {
        if (self.alertContentView) {
            UIViewController *vc = [[self class] viewControllerOfView:self.alertContentView];
            [UIView animateWithDuration:0.3 animations:^{
                vc.view.alpha = 0;
