...
@interface TMUIToastAnimator ()<CAAnimationDelegate>
...
@implementation TMUIToastAnimator
...
- (instancetype)initWithToastView:(TMUIToastView *)toastView {
...
- (void)zoomAnimationForShow:(BOOL)show withCompletion:(void (^)(BOOL))completion {
    ...
    [UIView animateWithDuration:0.25
                          delay:0.0
                        options:TMUIViewAnimationOptionsCurveOut|UIViewAnimationOptionBeginFromCurrentState
                     animations:^{
