 ...
 * 弹窗继承自`TMUICommonViewController`，因此可直接使用self.titleView的功能来实现双行标题，具体请查看`TMUINavigationTitleView`。
 * `TMUIDialogViewController`支持以类似`UIAppearance`的方式来统一设置全局的dialog样式，例如`[TMUIDialogViewController appearance].headerViewHeight = 48;`。
 *
 * @see TMUIDialogSelectionViewController
 * @see TMUIDialogTextFieldViewController
 */
@interface TMUIDialogViewController : UIViewController<TMUIModalPresentationContentViewControllerProtocol, TMUIModalPresentationComponentProtocol>
...
@property(nullable, nonatomic, strong, readonly) TMUIButton *cancelButton;
@property(nullable, nonatomic, strong, readonly) TMUIButton *submitButton;
@property(nullable, nonatomic, strong, readonly) CALayer *buttonSeparatorLayer;
@property(nullable, nonatomic, strong, readonly) TMUINavigationTitleView *titleView;
/**
 ...
 */
- (void)addCancelButtonWithText:(NSString *)buttonText block:(void (^ _Nullable)(__kindof TMUIDialogViewController *aDialogViewController))block;
 ...
 */
- (void)addSubmitButtonWithText:(NSString *)buttonText block:(void (^ _Nullable)(__kindof TMUIDialogViewController *aDialogViewController))block;
 ...
 */
@property(nullable, nonatomic, strong) TMUIModalPresentationViewController *modalPresentationViewController;
...
@interface TMUIDialogViewController (UIAppearance)

+ (instancetype)appearance;
@end

/// 表示没有选中的item
extern const NSInteger TMUIDialogSelectionViewControllerSelectedItemIndexNone;
 ...
 */
@interface TMUIDialogSelectionViewController : TMUIDialogViewController<TMUITableViewDelegate, TMUITableViewDataSource>
...
@property(nullable, nonatomic, strong, readonly) TMUITableView *tableView;

@property(nullable, nonatomic, copy) NSArray <NSString *> *items;

/// 表示单选模式下已选中的item序号，默认为TMUIDialogSelectionViewControllerSelectedItemIndexNone。此属性与 `selectedItemIndexes` 互斥。
...
@property(nullable, nonatomic, copy) void (^cellForItemBlock)(__kindof TMUIDialogSelectionViewController *aDialogViewController, __kindof TMUITableViewCell *cell, NSUInteger itemIndex);
@property(nullable, nonatomic, copy) CGFloat (^heightForItemBlock)(__kindof TMUIDialogSelectionViewController *aDialogViewController, NSUInteger itemIndex);
@property(nullable, nonatomic, copy) BOOL (^canSelectItemBlock)(__kindof TMUIDialogSelectionViewController *aDialogViewController, NSUInteger itemIndex);
@property(nullable, nonatomic, copy) void (^didSelectItemBlock)(__kindof TMUIDialogSelectionViewController *aDialogViewController, NSUInteger itemIndex);
@property(nullable, nonatomic, copy) void (^didDeselectItemBlock)(__kindof TMUIDialogSelectionViewController *aDialogViewController, NSUInteger itemIndex);
 ...
 */
@interface TMUIDialogTextFieldViewController : TMUIDialogViewController
...
- (void)addTextFieldWithTitle:(nullable NSString *)textFieldTitle configurationHandler:(void (^ _Nullable)(TMUILabel *titleLabel, TMUITextField *textField, CALayer *separatorLayer))configurationHandler;

@property(nullable, nonatomic, copy, readonly) NSArray<TMUILabel *> *textFieldTitleLabels;
@property(nullable, nonatomic, copy, readonly) NSArray<TMUITextField *> *textFields;
...
@property(nullable, nonatomic, copy) BOOL (^shouldEnableSubmitButtonBlock)(__kindof TMUIDialogTextFieldViewController *aDialogViewController);
