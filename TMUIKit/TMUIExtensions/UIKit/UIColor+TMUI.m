...
+ (UIColor *)tmui_colorWithHexString:(NSString *)hexString {
    ...
    switch ([colorString length]) {
        case 3: // #RGB
            alpha = 1.0f;
            red   = [self tmui_colorComponentFrom: colorString start: 0 length: 1];
            green = [self tmui_colorComponentFrom: colorString start: 1 length: 1];
            blue  = [self tmui_colorComponentFrom: colorString start: 2 length: 1];
            break;
        case 4: // #ARGB
            alpha = [self tmui_colorComponentFrom: colorString start: 0 length: 1];
            red   = [self tmui_colorComponentFrom: colorString start: 1 length: 1];
            green = [self tmui_colorComponentFrom: colorString start: 2 length: 1];
            blue  = [self tmui_colorComponentFrom: colorString start: 3 length: 1];
            break;
        case 6: // #RRGGBB
            alpha = 1.0f;
            red   = [self tmui_colorComponentFrom: colorString start: 0 length: 2];
            green = [self tmui_colorComponentFrom: colorString start: 2 length: 2];
            blue  = [self tmui_colorComponentFrom: colorString start: 4 length: 2];
            break;
        case 8: // #AARRGGBB
            alpha = [self tmui_colorComponentFrom: colorString start: 0 length: 2];
            red   = [self tmui_colorComponentFrom: colorString start: 2 length: 2];
            green = [self tmui_colorComponentFrom: colorString start: 4 length: 2];
            blue  = [self tmui_colorComponentFrom: colorString start: 6 length: 2];
            break;
        default: {
...
+ (CGFloat)tmui_colorComponentFrom:(NSString *)string start:(NSUInteger)start length:(NSUInteger)length {
