...
@protocol TMUITextViewDelegate <UITextViewDelegate>
 ...
 */
@interface TMUITextView : UITextView

@property(nonatomic, weak) id<TMUITextViewDelegate> delegate;
...
/**
 *  在使用 maximumTextLength 功能的时候，是否应该把文字长度按照 [NSString (TMUI) tmui_lengthWhenCountingNonASCIICharacterAsTwo] 的方法来计算。
 *  默认为 NO。
 */
