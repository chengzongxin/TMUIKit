...
这时你可以将对象A包装为一个 TBTWeakObjectContainer，并改为通过强引用方式（OBJC_ASSOCIATION_RETAIN_NONATOMIC/OBJC_ASSOCIATION_RETAIN）绑定这个 TMUIWeakObjectContainer，进而安全地获取原始对象A。
*/
@interface TBTWeakObjectContainer : NSProxy

/// 将一个 object 包装到一个 TBTWeakObjectContainer 里
