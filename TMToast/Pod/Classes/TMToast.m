...
- (void)loadUI {
    ...
    self.msgLbl.font = [UIFont systemFontOfSize:12 weight:UIFontWeightRegular];
...
+ (void)toastScore:(NSInteger)score content:(NSString *)content {
    ...
    if (!icon ||
        ...
        NSMutableAttributedString *rightTxtStr = [[NSAttributedString alloc] initWithString:[NSString stringWithFormat:@" +%ld兔币", score] attributes:@{NSForegroundColorAttributeName: [UIColor whiteColor], NSFontAttributeName: [UIFont systemFontOfSize:12 weight:UIFontWeightRegular]}].mutableCopy;
